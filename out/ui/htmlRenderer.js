...
class HtmlRenderer {
    ...
    static generateModelSelectorHtml(modelSelectorState, apiClient) {
    ...
    static generateMessagesHtml(messages) {
        if (!messages.length) {
     ...
     */
    static convertTextListsToHtml(text) {
    ...
    static generateChatHtml(modelSelectorState, apiClient, messages) {
